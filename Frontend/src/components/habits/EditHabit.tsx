					...
					<Modal.Body>
						<Form onSubmit={handleEditHabit}>
							<Form.Group className='mb-3'>
								<Form.Floating>
									<Form.Control value={habitData.name} onChange={e => setHabitData(prevState => ({ ...prevState, name: e.target.value }))} type='text' placeholder='Edit task...' />
									<Form.Label>Habit name</Form.Label>
								</Form.Floating>
							</Form.Group>
							<Form.Group className='mb-3'>
								<Form.Floating>
									<Form.Control value={habitData.description} onChange={e => setHabitData(prevState => ({ ...prevState, description: e.target.value }))} type='text' placeholder='Edit task...' />
